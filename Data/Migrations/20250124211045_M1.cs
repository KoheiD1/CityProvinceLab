    ...
    public partial class M1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 12, "Victoria", 300000, "BC" },
                    { 13, "Medicine Hat", 300000, "AB" },
                    { 14, "Moose Jaw", 100000, "SK" },
                    { 17, "Edmonton", 304400, "AB" },
                    { 25, "Saskatoon", 100000, "SK" },
                    { 72, "Vancouver", 1000000, "BC" },
                    { 100, "Calgary", 500000, "AB" },
                    { 113, "Regina", 444000, "SK" },
                    { 123, "Grand Forks", 4000, "BC" }
                });
